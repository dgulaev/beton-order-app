...
export const CONCRETE_CONFIG = {
  ...
  /** Минут на рейс на соске (подъезд + заливка + промывка), не на м³ */
  PLANT_LOAD_SLOT_MIN: 15,
  /** @deprecated для таймлайна UI; план использует PLANT_LOAD_SLOT_MIN */
  MINUTES_PER_CUBIC_METER: 1,
